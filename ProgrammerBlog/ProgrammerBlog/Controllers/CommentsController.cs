...
namespace ProgrammerBlog.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentId,UserId,Body,Deleted,PostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentId,UserId,Body,Deleted,PostId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
